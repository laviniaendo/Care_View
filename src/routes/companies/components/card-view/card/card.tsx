  ...
  return (
    <Card
      ...
      actions={[
        ...
        >
          ...
          >
            <Text size="xs">Contatos Envolvidos</Text>
            <AvatarGroup
              size={"small"}
              overlap
              gap="4px"
    ...
    >
      ...
      >
        ...
        >
          <Text type="secondary">Funcionamento</Text>
          <Text
            strong
            size="md"
            style={{
